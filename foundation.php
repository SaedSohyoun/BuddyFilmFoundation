...
<div class="container mt-4">
    <h1>Foundation Video's</h1>

    <form method="get" class="mb-4 d-flex gap-2" style="max-width:600px;">
        <input type="text" name="zoekterm" class="form-control" placeholder="Zoek video in Foundation..."
    ...
    <p>Er zijn geen video's gevonden in Foundation.</p>
    <?php else: ?>
    <div class="row">
