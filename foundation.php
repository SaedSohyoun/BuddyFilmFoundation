...
<div class="page-container">
    <div class="page-header">
        <h1><i class="fas fa-film me-3"></i>Foundation</h1>
        <p>Buddy Film Foundation operates as a starting point for refugee filmmakers, film crew, actors and creatives.
            We organise workshops, network events and coach our new colleagues with the ultimate goal being; landing
            paid jobs. We guide these professional filmmakers from development to execution and funding of their own
            film projects. We strive to be the link between the newcomers in this domain and the national and
            international film and tv-industry. </p>
    </div>

    <div class="container">
        <div class="search-section">
            <form method="get" class="search-form">
                <input type="text" name="zoekterm" class="form-control" placeholder="Search Foundation videos..."
        ...
        <div class="no-results">
            ...
            <p><?= $zoekterm ? 'No Foundation videos match your search criteria.' : 'No Foundation videos available yet.' ?>
            </p>
        </div>
        <?php else: ?>
