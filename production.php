    ...
    <div class="container">
        <div class="search-section">
            <form method="get" class="search-form">
                <input type="text" name="zoekterm" class="form-control" placeholder="Search Production videos..."
        ...
        <div class="no-results">
            ...
            <p><?= $zoekterm ? 'No Production videos match your search criteria.' : 'No Production videos available yet.' ?>
            </p>
        </div>
        <?php else: ?>
